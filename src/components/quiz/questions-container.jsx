          ...
          {currentQuestion.allAnswers.map((option, index) => (
            ...
            >
              <div className="flex items-center space-x-4">
                <div className="shrink-0 w-10 h-10 rounded-xl bg-linear-to-br from-blue-600 to-cyan-600 flex items-center justify-center text-white font-bold group-hover:scale-110 transition-transform">
